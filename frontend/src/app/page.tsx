                ...
                <section className="hidden md:flex flex-col items-center justify-center w-full max-w-5xl mx-auto py-20 px-6" style={{ background: 'url(/luxury-india-bg.jpg) center/cover no-repeat', borderRadius: '2rem' }}>
                    ...
                    <div className="w-full max-w-lg mb-8">
                        ...
                        >
                            ...
                            >
                                {/* Send icon */}
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b0b3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                            </button>
                            <button
