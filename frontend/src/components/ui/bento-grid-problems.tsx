...
const problems = [
  ...
  className: "md:col-span-2 bg-white dark:bg-black/90 border border-amber-200 hover:border-amber-300 transition-all duration-300 rounded-2xl shadow-lg",
  ...
  className: "md:col-span-1 bg-white dark:bg-black/90 border border-amber-200 hover:border-amber-300 transition-all duration-300 rounded-2xl shadow-lg",
